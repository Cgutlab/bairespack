                ...
                <div class="col-md-8 offset-md-2">
                    <form action="{{ route('post.venta.mail') }}" method="post" class="row">
                        ...
                        <div class="col-md-12 text-center my-4">
                            <button type="submit" onclick="gtag_report_conversion()" class="btn rounded-pill baires-fondo px-5">{{ __('Submit') }}</button>
                        </div>
                    </form>
                </div>
            </div>
...
@endsection
@push('script')
    <script src="https://www.google.com/recaptcha/api.js?render=6LdJe68UAAAAAL0PTITisoex0FWpIqetdA4Fa73k"></script>
    <script>
        grecaptcha.ready(function() {
            grecaptcha.execute('6LdJe68UAAAAAL0PTITisoex0FWpIqetdA4Fa73k', {action: 'homepage'}).then(function(token) {
            ...
            });
        });
    </script>
