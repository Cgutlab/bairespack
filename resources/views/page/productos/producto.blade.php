                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row ">
                                                            <div class="col-md-6 border d-flex align-items-center justify-content-center">
                                                                @gallery
                                                                @slot('gallery',$item->image)
                                                                @slot('id',3)
                                                                         @slot('alto','350px')
                                                                    ...
                                                                    <a href="{{ route('subfamilia',['familia' => $dosificadora->family_id]) }}" class=" " style="text-decoration: none; color: unset;">
                                                                        <div class="card shadow-none">
                                                                            <div class="card-body text-center p-0">
                                                                                <img class="img-fluid" src="{{ asset($dosificadora->image[0]['image'] ?? '') }}" style="height: 250px;" alt="Card image cap">
                                                                            </div>
                    ...
                    <div class="col-md-3 mb-5">
                        <a href="{{ route('producto',['producto' => $item->id,'config' => $producto->family_id]) }}" class=" " style="text-decoration: none; color: unset;">
                              <div class="card shadow-none">
                                    ...
                                    @endif
                                    <div class="card-footer bg-white text-center" style="height: 150px">
                                        <p>{!! $item->general->text{'title_'.App::getLocale()} ?? '' !!}</p>
                                        <h5 class="m-0">
